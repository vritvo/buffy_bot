...
<body>{svg_html}
    ...
    <footer>
        <div class="container">
            <p><a href="https://github.com/vritvo/buffy_bot">Vibe coded</a> at the <a href="https://www.recurse.com">Recurse Center</a><br>Generated by <a class="glitch-text" href="{tech_page}" style="{glitch_style}">Buffy Bot</a></p>
        </div>
    </footer>
</body>
</html>
